...
/**
 * Created by duyvu on 4/5/16.
 */
public class FavoriteTimelineFragment extends TweetsListFragment {

    private static String screenName;
    public static FavoriteTimelineFragment newInstance(String sc) {
    ...
    protected void callApi(int page) {
        client.getFavoriteList(screenName, page, new JsonHttpResponseHandler() {
            // Success
            @Override
